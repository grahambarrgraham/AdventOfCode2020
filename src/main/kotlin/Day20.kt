...
object Day20 {
    ...
    fun part2(strings: List<List<String>>): Long {
        val arrangement = arrangeTiles(strings)!!
        val images : Map<String, List<List<String>>> = loadImages(strings)
        val image : List<List<String>> = arrangeImage(arrangement, images)
        val seahorses : Int = countSeaHorses(image)
        val hashes = image.flatten().map { it.count { it == '#' } }.sum()
        return (hashes - (15 * seahorses)).toLong()
    }

    private fun countSeaHorses(image: List<List<String>>): Int {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    private fun arrangeImage(arrangement: Tile, images: Map<String, List<List<String>>>): List<List<String>> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    private fun loadImages(strings: List<List<String>>): Map<String, List<List<String>>> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    data class Tile(val top: String, val left: String, val right: String, val bottom:
        ...
        private fun topBottom(t1: Tile, t2: Tile): Tile? =
                if (t1.bottom == t2.top) Tile(t1.top, t1.left + t2.left, t1.right + t2.right, t2.bottom,
                        ...
                        t1.ids + t2.ids, Parents(t1, t2, true)) else null
    }
    ...
    data class Parents(val t1: Tile, val t2: Tile, val isTopBotton: Boolean)
