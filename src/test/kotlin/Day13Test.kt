...
class Day13Test {
    ...
    fun part2_simple() {
        ...
        assertThat(Day13.part2(listOf("", "67,x,7,59,61")), `is`(779210L))
        assertThat(Day13.part2(listOf("", "67,7,x,59,61")), `is`(1261476L))
        assertThat(Day13.part2(listOf("", "1789,37,47,1889")), `is`(1202161486L))
        assertThat(Day13.part2(loadStringListWithoutBlanks("/day13_simple.txt")), `is`(1068781L))
    }

    @Test
    fun part2() {
        assertThat(Day13.part2(loadStringListWithoutBlanks("/day13_data.txt")), `is`(803025030761664L))
    }
